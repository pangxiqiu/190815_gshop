  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      <img class="content-image"
           :src="info.avatar">
      <div class="header-content"  @click="ShowShop">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="ShowSupport">
      ...
      <div class="shop-brief-modal" v-show="shopShow">
        ...
        <span class="content-tag">
          ...
          <div class="mask-footer" @click="ShowShop">
            <span class="iconfont icon-guanbixiao"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      ...
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="ShowSupport">
          <span class="iconfont icon-guanbixiao"></span>
        </div>
      </div>
