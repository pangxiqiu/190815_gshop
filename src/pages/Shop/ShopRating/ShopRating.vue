  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on: onlyShowText}" @click="changeTextShow">
        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType === 0 ? 'icon-zan2' : 'icon-caishixin-'"></span>
                <span class="item" v-for="(rate, index) in rating.recommend" :key="index">{{rate}}</span>
              </div>
...
export default {
  ...
  data () {
    return {
      selectType: 0, // 评价类型：0满意  1不满意  2全部
